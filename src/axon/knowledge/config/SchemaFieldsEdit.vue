        ...
        <div class="row">
                    ...
                    <thead>
                        <tr>
                            ...
                            <th @click="toggleSort('name')">
                                {{ $t('axon.knowledge.md.dataSchemaField.name') }} / {{ $t('axon.knowledge.md.dataSchemaField.caption') }}
                                <i
                                    class="sort up icon"
            ...
            <div class="six wide column">
                ...
                <div v-if="!readonly">
                    ...
                    >{{ $t('axon.shared.create') }}</button>
                    <button
                        class="ui negative button"
                        :class="{ disabled: !selected}"
                        v-if="mode !== 'create'"
                        @click.prevent="onDelete"
                    >{{ $t('axon.shared.delete') }}</button>
                    <button
                        class="ui primary button"
                        v-if="mode === 'create'"
                        @click.prevent="onSave"
                    >{{ $t('axon.shared.save') }}</button>
                    <button
                        class="ui basic button"
                        v-if="mode === 'create'"
                        @click.prevent="onCancel"
                    >{{ $t('axon.shared.cancel') }}</button>
                </div>
                <form class="ui form" v-if="selected">
                    <div class="field">
