    ...
    <app-form>
        ...
        <template slot="toolbar">
            ...
            <div class="right floated three wide column">
                <router-link class="ui primary button" to="schema/create/new">
        ...
        <sui-modal v-model="modalContext.open" size="tiny">
            ...
            <sui-modal-content image>
                <p>{{ $t('axon.knowledge.md.dataSchema.delete', {name: modalContext.name})}}?</p>
            </sui-modal-content>
            <sui-modal-actions>
...
<script lang="ts">
    ...
    export default class DataSchemaList extends Vue {
        ...
        performDelete() {
            this.deleteDataSchema(this.modalContext.id);
            this.modalContext = {
                open: false,
                id: null,
                name: null,
